...
export class Negociacao {
  ...
  get volume() {
    return (
      ...
      __classPrivateFieldGet(this, _valor)
    );
  }
}
(_data = new WeakMap()),
...
//File gerado pelo ts
/*O TS converteu o código escrito usando o que há de mais
 *moderno em TS pra uma linguagem compatível com o ECMAScript6 e
 *no ES6 ñ tempos propriedades privadas.*/
